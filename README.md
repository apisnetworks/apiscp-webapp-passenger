...
This is a native module for Passenger on ApisCP. Native modules are shipped with ApisCP
...
git clone https://github.com/apisnetworks/apiscp-webapp-passenger config/custom/webapps/passenger
